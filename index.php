...
<body>
  ...
  <div class="layout">
    ...
    <div class="baseFrame" id="toDoList">
      ...
      <!--提交按鈕型態為submit「傳送資料」--><div class="baseContent">
        <!--提交按鈕型態為submit「傳送資料」--><div class="page" v-if="list[0].page==true">
                  <div class="title">{{list[0].name}}</div>
          <!--新增開始-->
  <!--提交按鈕型態為submit「傳送資料」--><div class="content">
  ...
  <div class="list">
                <ul>
                  ...
                  try {
                    ...
                    $query = "SELECT * FROM TB_GROUPFWHERE UNO = '$uno'";
